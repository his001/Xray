...
namespace XrayTEXT
{
    ...
    public class ExifMetadata
    {
        ...
        public decimal? HorizontalResolution
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif:{uint=282}");
                if (val != null)
                {
        ...
        public decimal? VerticalResolution
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif:{uint=283}");
                if (val != null)
                {
                    return ParseUnsignedRational((ulong)val);
                }
        ...
        public string EquipmentManufacturer
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif:{uint=271}");
        ...
        public string CameraModel
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif:{uint=272}");
                return (val != null ? (string)val : String.Empty);
            }
        }
        ...
        public string CreationSoftware
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif:{uint=305}");
                return (val != null ? (string)val : String.Empty);
            }
        }
        ...
        public ColorRepresentation ColorRepresentation
        {
            get
            {
                try
                {
                    ...
                    return ColorRepresentation.Unknown;
                }
            }
        }
        ...
        public decimal? ExposureCompensation
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif/subifd:{uint=37380}");
                if (val != null)
                {
        ...
        public decimal? LensAperture
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif/subifd:{uint=33437}");
                if (val != null)
                {
                    return ParseUnsignedRational((ulong)val);
                }
        ...
        public decimal? FocalLength
        {
            get
            {
                object val = null;//QueryMetadata("/app1/ifd/exif/subifd:{uint=37386}");
                if (val != null)
                {
                    return ParseUnsignedRational((ulong)val);
                }
        ...
        public ushort? IsoSpeed
        {
            get
            {
                return null;//(ushort?)QueryMetadata("/app1/ifd/exif/subifd:{uint=34855}");
            }
        }
        ...
        public ExposureMode ExposureMode
        {
            get
            {
                ushort? mode = null;//(ushort?)QueryMetadata("/app1/ifd/exif/subifd:{uint=34850}");
        ...
        public WhiteBalanceMode WhiteBalanceMode
        {
            get
            {
                ushort? mode = null;//(ushort?)QueryMetadata("/app1/ifd/exif/subifd:{uint=37384}");
        ...
        public DateTime? DateImageTaken
        {
            get
            {
                object val = QueryMetadata("/app1/ifd/exif/subifd:{uint=36867}"); //null;// 
                if (val == null)
                {
                    return null;
                }
